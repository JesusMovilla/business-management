 ...
 * inversiones (investments) y gastos (expenses / expense_categories).
...
async function clean() {
	...
	console.log(
		"Base de datos limpiada: se conservaron usuarios, roles, grupos de inversores, inversiones y gastos.",
	);
	process.exit(0);
}
